...
foreach($user in $csv){
        ...
        set-contact -identity $user.name -phone $user.phone -streetaddress $user.streetaddress -postalcode $user.postalcode -company $user.company -department $user.department -office $user.officename -title $user.title
        }
