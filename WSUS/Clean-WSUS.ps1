...
[string]$AdamjWSUSServer = "sbdwusp02.ecimain.ecipay.com"
...
[string]$AdamjMailReportEmailFromAddress = "WSUS@ECIPAY.COM"

# To: address for email notifications. Example: "firstname.lastname@domain.com"
[string]$AdamjMailReportEmailToAddress = "rnemeth@ecipay.com"
...
[string]$AdamjMailReportSMTPServer = "webmail.ecipay.com"
